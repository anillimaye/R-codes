...
# Takes a column of values as input and computes mean. Performs a z test to test whether the sample mean is significantly different from a known standard. This code will work on a tab delimited file which has a column of a given number of measurements. The column header is "measurements".
